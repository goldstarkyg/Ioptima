<?php
/*
Plugin Name: Adaptive Options Framework Import/Export
Plugin URI: http://wpadaptive.com
Description: An extension to the Options Framework that offers file base import/export of theme options.
Version: 1.0
...
class OptionsFramework_Backup
{
    ...
    {
        $this->admin_page = add_submenu_page('tools.php', __('OptionsFramework Import / Export', 'OptionsFramework'), __('Theme Options Import / Export', 'OptionsFramework'), 'manage_options', $this->token, array(&$this, 'admin_screen'));
...
//                wp_enqueue_style('admin-style', OPTIONS_FRAMEWORK_DIRECTORY . 'css/admin-style.css');
    ...
    <div class="wrap">
        ...
        <div class="import">
            ...
            <form enctype="multipart/form-data" method="post"
                  action="<?php echo admin_url('admin.php?page=' . $this->token); ?>">
        ...
        <div class="export">
            ...
            <form method="post" action="<?php echo admin_url('admin.php?page=' . $this->token); ?>">
                ...
                <input type="submit" class="button"
                       value="<?php _e('Download Export File', 'OptionsFramework'); ?>"/>
            </form>
        </div>
    ...
    function import()
    {
        ...
        if (!isset($_FILES['OptionsFramework-import-file'])) {
            return;
...
add_action('init', 'adap_init_options_export');
