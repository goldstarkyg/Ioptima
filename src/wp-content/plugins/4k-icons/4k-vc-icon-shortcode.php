...
class FourKIconShortcode {
	...
	public function fixVCCss() {
		echo "<style>
            ...
            .wpb_4k_icon .wpb_element_title .vc_element-icon {
				background-image: url(" . plugins_url( 'vc-icon.png', __FILE__ ) . ");
			}
		</style>";
	}
	...
	public function integrateWithVC() {
        add_shortcode_param( '4k_icon', array( $this, 'createIconSettingsField' ), plugins_url( 'js/script-vc-ck.js', __FILE__ ) );
	}
	...
	public function renderShortcode( $atts, $content ) {
		...
		if ( ! empty( $atts['icon'] ) ) {
			...
			wp_enqueue_style( '4k-icons', plugins_url( 'css/icon-styles.css', __FILE__ ), null, VERSION_GAMBIT_VC_4K_ICONS );
			wp_enqueue_script( '4k-icons', plugins_url( 'js/script-ck.js', __FILE__ ), array( 'jquery' ), VERSION_GAMBIT_VC_4K_ICONS, true );
		}
